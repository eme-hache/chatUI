...
export default function About ({ toggleDetails }) {
  return (
    <div className='h-full relative p-8 scrollbar-thin scrollbar-thumb-gray-500 overflow-y-scroll scrollbar-thumb-rounded-full'>
      <button
      ...
      <div className=''>
        ...
        <div className='flex gap-3 items-center mb-6'>
          <div className='w-12 h-12 bg-[#292933] flex items-center justify-center rounded-full'>
